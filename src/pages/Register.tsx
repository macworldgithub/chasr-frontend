    ...
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-xs sm:text-sm text-slate-400 mt-1">Setup your organization scope in Chasr</p>
        </div>
        ...
        <div className="glass-panel border border-dark-border/90 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-glass">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="org_acme_corp (defaults to 'default-org')"
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-dark-card border border-dark-border text-slate-200 text-sm focus:outline-none focus:border-cyan-500 transition-all font-mono"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-gradient-to-r from-brand-600 to-cyan-500 text-white font-semibold text-sm hover:opacity-90 transition-all shadow-glow-cyan flex items-center justify-center gap-2 group disabled:opacity-50 mt-2"
            >
