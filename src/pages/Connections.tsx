              ...
              <table className="min-w-full text-left text-xs">
                <thead>
                  <tr className="border-b border-dark-border text-slate-400 font-mono uppercase tracking-wider text-[11px]">
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Name</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Email</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Phone</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Payment Terms</th>
          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0">
            <div className="inline-block min-w-full align-middle px-4 sm:px-0">
              <table className="min-w-full text-left text-xs">
                <thead>
                  <tr className="border-b border-dark-border text-slate-400 font-mono uppercase tracking-wider text-[11px]">
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Invoice</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Contact</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Due Date</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Total</th>
              ...
              <table className="min-w-full text-left text-xs">
                <thead>
                  <tr className="border-b border-dark-border text-slate-400 font-mono uppercase tracking-wider text-[11px]">
                    ...
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Auth Type</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Organization / Tenant</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Status</th>
                    <th className="pb-3 px-3 sm:px-4 whitespace-nowrap">Last Synced</th>
                    <th className="pb-3 px-3 sm:px-4 text-right whitespace-nowrap">Actions</th>
                  </tr>
                </thead>
                        ...
                        <td className="py-3.5 sm:py-4 px-3 sm:px-4 font-mono whitespace-nowrap">
                          {org ? (
                            <div className="flex items-center gap-1.5 text-cyan-300 font-semibold">
                              ...
                              <span className="truncate max-w-[150px] sm:max-w-[200px]">{org.name}</span>
                              {org.currencyCode && (
